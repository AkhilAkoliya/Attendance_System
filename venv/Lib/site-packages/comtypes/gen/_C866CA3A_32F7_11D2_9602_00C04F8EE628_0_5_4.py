...
__all__ = [
    'SAFT48kHz8BitStereo', 'DISPID_SVEStreamEnd',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFTGSM610_22kHzMono',
    'SpeechAudioFormatType', 'SSTTTextBuffer',
    'SpeechWordPronounceable', 'DISPID_SGRsFindRule',
    'SSSPTRelativeToEnd', 'DISPID_SVEPhoneme', 'SRAExport',
    'SpeechDisplayAttributes', 'SPPS_RESERVED4', 'DISPID_SOTsCount',
    'SAFT11kHz8BitMono', 'SVSFUnusedFlags', 'DISPID_SVSkip',
    'SVSFIsNotXML', 'ISpResourceManager', 'SPPARTOFSPEECH',
    'SAFTCCITT_ALaw_11kHzMono', 'SpeechCategoryRecognizers',
    'DISPID_SPRuleFirstElement', 'SVP_19',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPAs_NewEnum',
    'SAFTText', 'SpeechRecoProfileProperties', 'DISPID_SVPause',
    'ISpeechLexiconPronunciations', 'ISpeechRecoResult2',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRRTTickCount',
    'DISPID_SPRulesCount', 'ISpeechBaseStream', 'DISPID_SGRName',
    'SpeechTokenKeyUI', 'SPPS_Interjection', 'ISpeechGrammarRules',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPRNumberOfElements',
    'SPTEXTSELECTIONINFO', 'DISPID_SRCEPhraseStart',
    'DISPID_SPILanguageId', 'SPXRO_Alternates_SML',
    'ISpStreamFormatConverter', 'SPEI_END_SR_STREAM',
    'ISpeechObjectToken', 'SpeechCategoryAudioOut', 'SP_VISEME_10',
    'SRERecoOtherContext', 'SDTReplacement', 'SPSLMA',
    'SPGS_EXCLUSIVE', 'DISPID_SPRsItem', 'DISPID_SBSWrite',
    'SDKLCurrentConfig', 'SVP_5', 'SPWORDLIST', 'SPEI_SR_BOOKMARK',
    'SPEI_MAX_SR', 'SPPHRASEELEMENT', 'DISPID_SPRFirstElement',
    'DISPID_SRCEEndStream', 'tagSPTEXTSELECTIONINFO',
    'eLEXTYPE_PRIVATE18', 'SPSHORTCUTPAIR',
    'SWPKnownWordPronounceable', 'SPGRAMMARWORDTYPE',
    'SAFT22kHz16BitStereo', 'SPSHT_NotOverriden', 'SPEI_SOUND_START',
    'DISPID_SVAudioOutput', 'ISpeechRecoResult', 'eLEXTYPE_PRIVATE17',
    'SGDSActiveWithAutoPause', 'SDTRule', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRSTType', 'SpMMAudioEnum', 'SSFMOpenForRead',
    'DISPID_SVAudioOutputStream', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFT32kHz8BitStereo', 'DISPID_SRCBookmark', 'ISpObjectWithToken',
    'ISpeechAudio', 'DISPID_SGRId', 'DISPID_SBSSeek',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechPhraseRule',
    'SAFT32kHz16BitMono', 'ISpRecognizer2', 'SPEVENTSOURCEINFO',
    'SpeechTokenShellFolder', 'SpObjectToken', 'SPWF_SRENGINE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SAEventHandle',
    'DISPID_SPPNumberOfElements', 'SP_VISEME_17',
    'SAFT22kHz16BitMono', 'DISPID_SOTDisplayUI', 'ISpRecoCategory',
    'DISPID_SPERequiredConfidence', 'SpeechGrammarTagDictation',
    'DISPID_SDKSetStringValue', 'STCLocalServer',
    'DISPID_SLPPartOfSpeech', 'SP_VISEME_0',
    'DISPID_SGRSTPropertyValue', 'Speech_Max_Pron_Length',
    'SpeechRunState', 'SpeechInterference', 'ISpeechPhraseInfo',
    'tagSPPROPERTYINFO', 'SPEI_START_INPUT_STREAM', 'SPXRO_SML',
    'SPWT_DISPLAY', 'SPFILEMODE', 'eLEXTYPE_PRIVATE3',
    'SDA_Consume_Leading_Spaces', '_ISpeechVoiceEvents',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPEs_NewEnum',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SDKGetStringValue',
    'DISPID_SOTCreateInstance', 'SPWAVEFORMATTYPE', 'SP_VISEME_4',
    'ISpEventSource', 'SRAImport', 'ISpNotifySink', 'SPEI_ADAPTATION',
    'ISpRecognizer', 'DISPID_SRGDictationLoad',
    'DISPID_SOTGetDescription', 'DISPID_SREmulateRecognition',
    'DISPID_SVSRunningState', 'DISPID_SWFEBlockAlign',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRGSetTextSelection',
    'SDKLDefaultLocation', 'SpInProcRecoContext',
    'ISpNotifyTranslator', 'IStream', 'SAFT48kHz8BitMono',
    'SAFT24kHz16BitMono', 'SPSInterjection', 'SPPS_NotOverriden',
    'SECFDefault', 'DISPID_SVSInputWordPosition',
    'IInternetSecurityManager', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SpeechGrammarRules', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_END_INPUT_STREAM', 'DISPID_SpeechObjectToken',
    'SRESoundEnd', 'SGRSTTDictation', 'DISPID_SLPType',
    'DISPID_SPCIdToPhone', 'DISPID_SRStatus',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechGrammarRule',
    'SPEI_INTERFERENCE', 'ISpeechObjectTokens', 'DISPID_SPRuleParent',
    'DISPID_SpeechAudio', 'SVEAllEvents', 'SPWORDPRONUNCIATIONLIST',
    'SPPHRASEREPLACEMENT', 'eLEXTYPE_RESERVED9', 'DISPID_SPPsCount',
    'DISPID_SRSClsidEngine', 'DISPID_SLGetWords', 'ISpeechVoice',
    'SDKLCurrentUser', 'SVP_4', 'ISpMMSysAudio', 'SAFT32kHz8BitMono',
    'SVP_6', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFTADPCM_11kHzMono',
    'SP_VISEME_13', 'SGSExclusive', 'DISPID_SABIBufferSize',
    'SREPrivate', 'SpNotifyTranslator', 'SPSMF_SAPI_PROPERTIES',
    'IEnumString', 'DISPID_SPIProperties', 'SPINTERFERENCE_TOOFAST',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRCPause',
    'ISpPhoneticAlphabetSelection', 'SpeechSpecialTransitionType',
    'SPAR_Low', 'SPEI_SOUND_END', 'SPSERIALIZEDRESULT',
    'WAVEFORMATEX', 'DISPID_SDKGetBinaryValue', 'SPSEMANTICERRORINFO',
    'DISPID_SOTCId', 'DISPID_SPEDisplayText', 'SAFTDefault',
    'DISPID_SAFType', 'SPCONTEXTSTATE', 'DISPID_SADefaultFormat',
    'SRCS_Disabled', 'SP_VISEME_18', 'UINT_PTR',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRGetPropertyNumber',
    'SVPAlert', 'SpStreamFormatConverter',
    'DISPID_SRSCurrentStreamNumber', 'SP_VISEME_20', 'SPPS_LMA',
    'SpeechRecognitionType', 'DISPID_SASNonBlockingIO',
    'SWPUnknownWordPronounceable',
    'SpeechGrammarTagUnlimitedDictation', 'SREHypothesis',
    'SAFTCCITT_ALaw_8kHzStereo', 'STSF_CommonAppData',
    'DISPID_SRCEFalseRecognition', 'ISpeechAudioFormat',
    'SPPS_Modifier', 'DISPID_SRCVoicePurgeEvent',
    'SpCompressedLexicon', 'DISPID_SpeechPhoneConverter',
    'eLEXTYPE_PRIVATE11', 'SRATopLevel',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SLGetPronunciations',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPEActualConfidence',
    'SPBO_TIME_UNITS', 'SpeechAddRemoveWord', 'SVEViseme', 'SVP_16',
    'DISPID_SPPId', 'SPEVENT', 'SPAS_RUN', 'SRESoundStart',
    'DISPID_SPEsItem', 'DISPID_SpeechAudioStatus', 'SPEI_RESERVED2',
    'SPBOOKMARKOPTIONS', 'SPSNotOverriden', 'SP_VISEME_8',
    'SRCS_Enabled', 'DISPID_SpeechWaveFormatEx', 'SDTAll',
    'DISPID_SGRSTText', 'SAFT8kHz8BitStereo', 'SPRST_ACTIVE_ALWAYS',
    'SVSFParseAutodetect', 'ISpPhoneConverter',
    'DISPID_SRCRetainedAudio', 'SPAUDIOBUFFERINFO', 'SVPNormal',
    'eLEXTYPE_PRIVATE10', 'SRTEmulated', 'DISPID_SLWsItem',
    'SPEI_SR_RETAINEDAUDIO', 'SAFTExtendedAudioFormat',
    'DISPID_SMSALineId', 'SPINTERFERENCE_NOISE', 'SpeechPartOfSpeech',
    'SpVoice', 'SpeechVisemeFeature', 'SPPHRASE', 'SpeechMicTraining',
    'SDKLLocalMachine', 'DISPID_SWFEAvgBytesPerSec', 'SPBO_PAUSE',
    'DISPID_SRCCmdMaxAlternates', 'SPRST_ACTIVE',
    'SPEI_START_SR_STREAM', 'SpeechTokenKeyFiles',
    'DISPID_SPERetainedStreamOffset', 'SSSPTRelativeToStart',
    'ISpeechCustomStream', 'DISPID_SWFEBitsPerSample',
    'STSF_LocalAppData', 'SREBookmark', 'SGDisplay', 'SPCS_ENABLED',
    'DISPID_SVEStreamStart', 'SpeechRuleAttributes',
    'SPWT_PRONUNCIATION', 'DISPID_SRGIsPronounceable',
    'ISpeechGrammarRuleState', 'SpeechStreamSeekPositionType',
    'DISPID_SASFreeBufferSpace', 'SP_VISEME_9', 'DISPID_SPPName',
    'SAFTADPCM_22kHzMono', 'DISPID_SPCPhoneToId',
    'DISPID_SPELexicalForm', 'SPINTERFERENCE_NONE', 'SPAUDIOSTATUS',
    'SVF_Emphasis', 'SRAORetainAudio', 'SpPhraseInfoBuilder',
    'SGLexical', 'SVEAudioLevel', 'SpeechAudioState',
    'DISPID_SPRuleChildren', 'SpInprocRecognizer', 'ISpShortcut',
    'DISPID_SpeechObjectTokenCategory', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFT12kHz16BitMono', 'SP_VISEME_1', 'SAFTADPCM_8kHzMono',
    'SPAS_CLOSED', 'SSSPTRelativeToCurrentPosition',
    'SVSFNLPSpeakPunc', 'DISPID_SWFEExtraData',
    'DISPID_SDKSetLongValue', 'DISPID_SGRsCommitAndSave', 'SpStream',
    'DISPID_SpeechVoice', 'DISPID_SPRuleId', 'SPSUnknown',
    'SpMMAudioOut', 'SRSActiveAlways', 'DISPID_SPIReplacements',
    'SPSHT_OTHER', 'SSFMCreateForWrite', 'SPRULESTATE',
    'DISPID_SVIsUISupported', 'DISPID_SRCEventInterests',
    'SAFTCCITT_ALaw_11kHzStereo', 'SASClosed',
    'DISPID_SRCEAudioLevel', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SGRSTWeight', 'DISPID_SRCCreateResultFromMemory',
    'SpeechRecoEvents', 'DISPID_SPRulesItem', 'SPPROPERTYINFO',
    'SVSFNLPMask', 'DISPID_SPEAudioSizeTime', 'ISpeechWaveFormatEx',
    'ISpStreamFormat', 'DISPID_SVSLastStreamNumberQueued',
    'SAFT11kHz8BitStereo', 'ISpRecoResult', 'SPSNoun', 'DISPID_SRGId',
    'DISPID_SpeechPhraseAlternate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SLGenerationId',
    'SSTTDictation', 'SAFT44kHz8BitMono',
    'DISPID_SPAStartElementInResult', 'DISPID_SVGetVoices',
    'SPSERIALIZEDPHRASE', 'SPFM_CREATE', 'Speech_StreamPos_RealTime',
    'DISPID_SPRuleConfidence', 'DISPID_SVSLastResult',
    'DISPID_SRRSpeakAudio', 'SPRST_INACTIVE', 'SPPS_SuppressWord',
    'SPCT_DICTATION', 'SVP_11', 'DISPID_SRRTimes', 'SVSFVoiceMask',
    'SPEI_WORD_BOUNDARY', 'SPEI_MAX_TTS', 'SPAS_PAUSE', 'SPWF_INPUT',
    'SpeechPropertyComplexResponseSpeed', 'ISpRecognizer3',
    'DISPID_SpeechMemoryStream', 'DISPID_SLWWord',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPRDisplayAttributes',
    'SPEI_MIN_TTS', 'DISPID_SMSGetData', 'SAFTNoAssignedFormat',
    'DISPID_SRRTStreamTime', 'DISPID_SWFEChannels', 'SBONone',
    'SDA_Two_Trailing_Spaces', 'SPLO_STATIC',
    'DISPID_SLRemovePronunciation', 'DISPID_SLWPronunciations',
    'IInternetSecurityMgrSite', 'SDA_No_Trailing_Space', 'SPBO_NONE',
    'DISPID_SpeechPhraseRules', 'SREPropertyNumChange',
    'SVESentenceBoundary', 'ISpProperties',
    'DISPID_SRAudioInputStream', 'DISPID_SVSPhonemeId',
    'DISPID_SGRSAddRuleTransition', 'ISpXMLRecoResult', 'SP_VISEME_5',
    'DISPID_SRSAudioStatus', 'Speech_Default_Weight',
    'DISPID_SRGRules', 'SPRULE', 'SAFT16kHz16BitMono',
    'eLEXTYPE_PRIVATE19', 'SPINTERFERENCE_TOOSLOW',
    'eLEXTYPE_PRIVATE12', 'SAFT24kHz8BitStereo', 'SINoise',
    'SPEI_HYPOTHESIS', 'SAFTCCITT_uLaw_22kHzStereo', 'tagSTATSTG',
    'eLEXTYPE_PRIVATE9', 'DISPID_SRCESoundEnd',
    'SpeechDictationTopicSpelling', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SGRSTsItem',
    'SpeechTokenValueCLSID', 'SECFIgnoreCase', 'SRTExtendableParse',
    'SGRSTTTextBuffer', 'SpeechVoiceEvents',
    'DISPID_SpeechXMLRecoResult', 'SPSMF_UPS', 'eLEXTYPE_USER',
    'SPPS_Unknown', 'SRSEIsSpeaking', 'DISPID_SGRAttributes',
    'ISpeechPhraseElement', 'SpMMAudioIn', 'DISPID_SpeechMMSysAudio',
    'DISPID_SDKSetBinaryValue', 'SINone', 'ISpStream',
    'DISPID_SDKDeleteKey', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechVoiceEvent', 'SP_VISEME_15',
    'SpeechVoiceSkipTypeSentence', 'SPSEMANTICFORMAT',
    'SPEI_SR_PRIVATE', 'SGRSTTRule', '_SPAUDIOSTATE',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRGDictationUnload', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SOTGetStorageFileName',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SOTMatchesAttributes',
    'SAFT32kHz16BitStereo', 'LONG_PTR', 'eLEXTYPE_RESERVED4',
    'SpObjectTokenCategory', 'SPEI_PHRASE_START',
    'SAFT8kHz16BitStereo', 'SP_VISEME_2', 'SVP_3', 'SGSEnabled',
    'SPGS_DISABLED', 'ISpPhoneticAlphabetConverter',
    'SPWORDPRONUNCIATION', 'DISPID_SPRs_NewEnum',
    'DISPID_SPRuleEngineConfidence', 'ISpPhraseAlt',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechRecoResult2',
    'SAFT12kHz8BitMono', 'DISPID_SVEAudioLevel', 'SREStateChange',
    'SpeechTokenIdUserLexicon', 'SPVPRI_NORMAL',
    'SAFT44kHz16BitStereo', 'DISPID_SGRSTsCount', 'DISPID_SPRText',
    'ISpEventSink', 'DISPID_SOTDataKey',
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_PRIVATE6',
    'SECHighConfidence', 'DISPID_SLWType', 'SVSFIsXML',
    'DISPID_SOTIsUISupported', 'SAFT16kHz8BitMono',
    'SECFIgnoreKanaType', 'SVP_17', 'ISpeechMMSysAudio', 'SPPS_Verb',
    'ISpeechPhoneConverter', 'DISPID_SRCreateRecoContext',
    'SPFM_NUM_MODES', 'SPINTERFERENCE_NOSIGNAL',
    'SAFTCCITT_uLaw_11kHzMono', 'SAFTCCITT_uLaw_44kHzMono',
    'SPAO_RETAIN_AUDIO', 'eWORDTYPE_DELETED',
    'ISpeechTextSelectionInformation', 'SASRun',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT22kHz8BitStereo',
    'DISPID_SDKEnumKeys', 'SpeechCategoryAppLexicons',
    'SpSharedRecoContext', 'SDTProperty', 'DISPID_SRCEAdaptation',
    'SVSFParseSsml', 'SPFM_OPEN_READWRITE',
    'SpeechPropertyResourceUsage', 'SAFTADPCM_8kHzStereo',
    'DISPID_SGRAddResource', 'SECLowConfidence', 'SRARoot',
    'DISPID_SPIAudioStreamPosition', 'ISpAudio',
    'DISPID_SPEEngineConfidence', 'SPAR_Medium',
    'DISPID_SpeechVoiceStatus', 'ISpeechFileStream',
    'DISPID_SRCState', 'eLEXTYPE_APP', 'DISPID_SVESentenceBoundary',
    'SPAUDIOOPTIONS', 'SPBINARYGRAMMAR', 'SPVISEMES',
    'ISpeechLexiconPronunciation', 'SVP_10', 'SpeechRuleState',
    'SPWORD', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechLexiconWord', 'DISPID_SVSLastBookmarkId',
    'SPSFunction', 'SPEI_REQUEST_UI',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SpeechPhraseElement', 'SREAudioLevel',
    'eLEXTYPE_PRIVATE15', 'eLEXTYPE_PRIVATE4', 'SECFEmulateResult',
    'SPEI_TTS_BOOKMARK', 'SVEPrivate', 'SVP_20', 'SWTAdded',
    'DISPID_SLPLangId', 'SPEI_UNDEFINED',
    'SpeechPropertyHighConfidenceThreshold',
    'SpTextSelectionInformation', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechRecoContextEvents', 'STSF_FlagCreate',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTGSM610_8kHzMono',
    'SpUnCompressedLexicon', 'DISPID_SRCERecognitionForOtherContext',
    'SpeechAllElements', 'DISPID_SPPFirstElement',
    'DISPID_SOTs_NewEnum', 'SAFTADPCM_22kHzStereo',
    'SPEI_SR_AUDIO_LEVEL', 'SECFIgnoreWidth', 'ISpeechGrammarRule',
    'ISpLexicon', 'DISPID_SPIGetText', 'eLEXTYPE_PRIVATE14',
    'eLEXTYPE_USER_SHORTCUT', 'SP_VISEME_6', 'DISPID_SPARecoResult',
    'SRERequestUI', 'SVEPhoneme', 'DISPID_SRRRecoContext',
    'DISPID_SGRSAddWordTransition', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPRules_NewEnum',
    'DISPID_SLGetGenerationChange', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SRTReSent', 'SVSFParseSapi', 'SVEStartInputStream',
    'ISpeechPhraseElements', 'SpeechLexiconType', 'DISPID_SRRTLength',
    'SPCT_COMMAND', 'SVEWordBoundary', 'DISPID_SVRate',
    'DISPID_SOTCGetDataKey', 'DISPID_SRCResume',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE13',
    'SpeechPropertyResponseSpeed', 'SpeechRegistryUserRoot',
    'ISpeechPhraseAlternate', 'ISpeechResourceLoader',
    'DISPID_SRCERecognition', 'SpSharedRecognizer',
    'SAFT48kHz16BitMono', 'SpeechCategoryAudioIn', 'DISPID_SVVolume',
    'DISPID_SVSInputWordLength', 'SpeechTokenKeyAttributes',
    'SpNullPhoneConverter', 'SAFTADPCM_44kHzMono', 'ISpObjectToken',
    'SECFNoSpecialChars', 'DISPID_SRState', 'SPLEXICONTYPE',
    'DISPID_SPIAudioSizeTime', 'SPSHT_EMAIL', 'DISPID_SGRSTNextState',
    'ISpeechMemoryStream', 'DISPID_SPPs_NewEnum',
    'DISPID_SRSSupportedLanguages', 'ISpeechPhraseProperty',
    'DISPID_SWFEFormatTag', 'DISPIDSPTSI_SelectionLength',
    'SPXMLRESULTOPTIONS', 'DISPID_SPEAudioStreamOffset', 'SVP_1',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPCT_SUB_DICTATION', 'SVP_18',
    'SpeechAudioVolume', 'SpFileStream', 'eLEXTYPE_PRIVATE7',
    'ISpeechRecognizerStatus', 'SVP_8', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SOTRemove', 'DISPID_SGRsDynamic',
    'DISPID_SVSInputSentencePosition',
    'SpeechRegistryLocalMachineRoot', 'SPWORDPRONOUNCEABLE',
    'ISpObjectTokenCategory', 'SPCT_SUB_COMMAND', 'DISPID_SOTSetId',
    'DISPID_SMSSetData', 'SP_VISEME_11', 'DISPID_SpeechRecoContext',
    'DISPID_SPPConfidence', 'SPRECORESULTTIMES', 'SP_VISEME_7',
    'SVP_0', 'SpeechAudioProperties', 'DISPID_SASetState',
    'STCInprocServer', 'SAFT16kHz16BitStereo', 'SPVOICESTATUS',
    'DISPID_SRRDiscardResultInfo', 'SPDKL_CurrentConfig',
    'SDTLexicalForm', 'SpPhoneConverter', 'SAFT8kHz8BitMono',
    'DISPID_SRCEPropertyStringChange', 'SAFTNonStandardFormat',
    'DISPID_SCSBaseStream', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPIDSPRG', 'DISPID_SLWsCount', 'SPVPRI_ALERT',
    'DISPID_SpeechPhraseReplacements', 'SGRSTTWildcard',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SWFESamplesPerSec',
    'SpResourceManager', 'SAFT11kHz16BitMono',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechPhraseReplacement',
    'SpeechBookmarkOptions', 'SPEI_VOICE_CHANGE', 'DISPID_SPACommit',
    'SRADefaultToActive', 'DISPID_SLWs_NewEnum', 'SP_VISEME_21',
    'ISpGrammarBuilder', 'SPWT_LEXICAL', 'DISPID_SRCCreateGrammar',
    'SpeechRecognizerState', 'SVP_12', '_ISpeechRecoContextEvents',
    'SRTStandard', 'SINoSignal', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SAVolume', 'DISPID_SRGDictationSetState',
    'ISpeechPhraseRules', 'ISpeechAudioStatus',
    'DISPID_SRCEInterference', 'DISPID_SGRClear', 'DISPID_SRCVoice',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpeechXMLRecoResult',
    'Speech_StreamPos_Asap',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpRecoGrammar',
    'SpLexicon', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SRCAudioInInterferenceStatus', 'SPCS_DISABLED',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechDataKey',
    'SAFT22kHz8BitMono', 'DISPID_SAFGuid', 'SGRSTTEpsilon',
    'SP_VISEME_14', 'SPEI_TTS_PRIVATE', 'SpeechDataKeyLocation',
    'DISPID_SVSVisemeId', 'DISPID_SPEPronunciation', 'SASStop',
    'SpeechAudioFormatGUIDText', 'SDTDisplayText', 'ISpPhrase',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRCESoundStart',
    'SASPause', 'DISPID_SOTCategory', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRRAlternates', 'eLEXTYPE_PRIVATE2', 'SRSEDone',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRCEEnginePrivate', 'ISpDataKey',
    'eWORDTYPE_ADDED', 'SPEI_PHONEME', 'ISpeechPhraseReplacements',
    'SREStreamEnd', 'DISPID_SpeechPhraseBuilder',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechRecoContext', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechVoiceSpeakFlags', 'SPEI_RESERVED6', 'DISPID_SLPsItem',
    'SPPHRASERULE', 'SITooLoud', 'SPEI_RESERVED1', 'DISPID_SLPsCount',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SMSAMMHandle',
    'DISPID_SOTGetAttribute', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SLPPhoneIds', 'DISPID_SPEDisplayAttributes',
    'SPPS_RESERVED2', 'SPPS_Noncontent', 'ISpeechPhraseRule',
    'ISpeechPhraseInfoBuilder', 'DISPID_SLPSymbolic',
    'DISPID_SRSetPropertyString', 'DISPID_SVSpeak',
    'DISPID_SRRGetXMLResult', 'DISPID_SRGCmdLoadFromMemory',
    'SRERecognition', 'SVF_Stressed',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SGRSTRule',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechEmulationCompareFlags', 'ISpRecoContext2',
    'DISPID_SpeechBaseStream', 'DISPID_SVEEnginePrivate', 'SVP_2',
    'SPRECOSTATE', 'SpeechTokenContext',
    'DISPID_SpeechRecognizerStatus', 'SGDSInactive',
    'DISPID_SpeechLexicon', 'SPSVerb',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRRecognizer',
    'SPDATAKEYLOCATION', 'DISPID_SMSADeviceId',
    'SGLexicalNoSpecialChars', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SGRsCount', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPRuleName',
    'SPADAPTATIONRELEVANCE', 'eLEXTYPE_RESERVED8', 'SGDSActive',
    'SPGRAMMARSTATE', 'SPPHRASEPROPERTY',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechRecoResultTimes',
    'DISPID_SDKEnumValues', 'SSFMCreate', 'DISPID_SBSFormat',
    'SLTUser', 'SVP_9', 'DISPID_SPPChildren', 'ISpRecoGrammar2',
    'SpeechCategoryVoices', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPAsCount', 'SP_VISEME_12', 'SPAR_Unknown',
    'SpeechRecoContextState', 'DISPID_SRRPhraseInfo', 'SpShortcut',
    'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPANumberOfElementsInResult', 'SPPS_RESERVED3',
    'DISPID_SRCEStartStream', 'DISPID_SRCEBookmark', 'SPEI_MIN_SR',
    'SECNormalConfidence', 'SVP_21', 'SAFTGSM610_44kHzMono',
    'DISPID_SDKGetlongValue', 'SGDSActiveUserDelimited',
    'SPDKL_DefaultLocation', 'SDTAudio', 'eLEXTYPE_RESERVED7',
    'DISPID_SDKOpenKey', 'SpeechAudioFormatGUIDWave',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRGetPropertyString',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRCERecognizerStateChange',
    'SVP_14', 'DISPID_SRRAudioFormat', 'DISPID_SPISaveToMemory',
    'DISPID_SGRs_NewEnum', 'SPGS_ENABLED', 'DISPID_SRCEHypothesis',
    'SAFTCCITT_uLaw_8kHzStereo', 'SREPropertyStringChange',
    'DISPID_SpeechPhraseElements', 'eLEXTYPE_PRIVATE8', 'SPAO_NONE',
    'SPINTERFERENCE_TOOLOUD', 'STSF_AppData',
    'DISPID_SVEventInterests', 'DISPID_SRProfile', 'SPPS_RESERVED1',
    'DISPID_SOTsItem', 'SSFMOpenReadWrite', '_RemotableHandle',
    'SPEI_RECOGNITION', 'DISPID_SOTId', 'SPSSuppressWord',
    'SPPS_Function', 'ISpeechPhraseAlternates', 'SITooFast',
    'DISPID_SRCRequestedUIType', 'SPEI_PROPERTY_NUM_CHANGE',
    'SRSInactiveWithPurge', 'SPVPRIORITY', 'SAFTGSM610_11kHzMono',
    'SPINTERFERENCE', 'SRTSMLTimeout', 'SFTInput', 'SVEBookmark',
    'DISPID_SpeechFileStream', 'DISPID_SOTCDefault',
    'SpeechGrammarWordType', 'DISPID_SVSpeakStream',
    'SpeechRetainedAudioOptions', 'DISPID_SGRSRule',
    'ISpeechVoiceStatus', 'DISPID_SVPriority', 'ISpVoice',
    'DISPID_SPIAudioSizeBytes', 'SRTAutopause', 'SP_VISEME_19',
    'DISPID_SLPs_NewEnum', 'SP_VISEME_16',
    'SpPhoneticAlphabetConverter', 'SpMemoryStream',
    'DISPID_SRDisplayUI', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SVP_7', 'SPFM_OPEN_READONLY', 'SAFT24kHz8BitMono',
    'SDTAlternates', 'SAFT48kHz16BitStereo', 'DISPID_SPIGrammarId',
    'DISPID_SpeechAudioBufferInfo', 'SFTSREngine',
    'DISPID_SpeechPhraseProperty', 'SPEI_VISEME', 'ISpNotifySource',
    'SPRS_INACTIVE', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPPEngineConfidence', 'SRAInterpreter',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SDKCreateKey',
    'DISPID_SVGetProfiles', 'DISPID_SVEViseme',
    'ISpeechPhraseProperties', 'DISPID_SpeechObjectTokens',
    'DISPID_SRCRecognizer', 'SREPhraseStart',
    'SWPUnknownWordUnpronounceable', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechLexiconProns', 'IEnumSpObjectTokens',
    'DISPID_SRGState', 'SAFTCCITT_uLaw_8kHzMono',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPIStartTime',
    'SAFT24kHz16BitStereo', 'SpeechLoadOption', 'SPAS_STOP',
    'DISPID_SAFGetWaveFormatEx', 'SRADynamic', 'SITooSlow',
    'SBOPause', 'SpeechUserTraining', 'eLEXTYPE_RESERVED10',
    'SpWaveFormatEx', 'STCAll', 'DISPID_SVEWord',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SVGetAudioInputs',
    'SpAudioFormat', 'DISPID_SPRsCount', 'SPSHORTCUTTYPE',
    'SPDKL_LocalMachine', 'SAFT12kHz8BitStereo', 'SPDKL_CurrentUser',
    'SPBO_AHEAD', 'SLOStatic', 'SpeechGrammarTagWildcard',
    'DISPID_SPIElements', 'eLEXTYPE_PRIVATE20', 'SREAdaptation',
    'SVEVoiceChange', 'SAFT8kHz16BitMono',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPPsItem',
    'ISpeechRecoResultDispatch', 'SGRSTTWord', 'ISequentialStream',
    'DISPID_SASState', 'DISPID_SGRInitialState',
    'SPEI_RECO_STATE_CHANGE', 'SpeechVoicePriority',
    'SGPronounciation', 'DISPID_SDKDeleteValue',
    'SDA_One_Trailing_Space', 'SPAUDIOSTATE', 'SVP_13',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPIEnginePrivateData',
    'SVSFIsFilename', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPSHT_Unknown',
    'SVP_15', 'SPRS_ACTIVE', 'SLTApp', 'DISPID_SRGCommit',
    'SpeechFormatType', 'DISPID_SGRSTPropertyName', 'STCRemoteServer',
    'ISpeechPhraseReplacement', 'DISPID_SABIMinNotification',
    'DISPID_SRCERequestUI', 'DISPID_SVAlertBoundary',
    'DISPID_SRIsShared', '__MIDL_IWinTypes_0009', 'SPVPRI_OVER',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRGetRecognizers',
    'DISPID_SVDisplayUI', 'SPCT_SLEEP', 'DISPID_SpeechLexiconWords',
    'SREFalseRecognition', 'SpeechGrammarState', 'ISpeechRecoGrammar',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechPhraseProperties', 'SpCustomStream',
    'DISPID_SVEBookmark', 'DISPID_SpeechRecoResult', 'SRSInactive',
    'SRAONone', 'DISPID_SRIsUISupported', 'SPLO_DYNAMIC',
    'DISPID_SGRsItem', 'SPEI_PROPERTY_STRING_CHANGE', 'SPWORDTYPE',
    'DISPID_SRGCmdSetRuleState', 'SpeechVisemeType', 'SP_VISEME_3',
    'SPRST_NUM_STATES', 'SpeechCategoryPhoneConverters',
    'SGSDisabled', 'SRSActive', 'SPFM_CREATE_ALWAYS',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRGetFormat',
    'DISPID_SPCLangId', 'DISPID_SGRSTransitions',
    'DISPID_SGRAddState', 'ISpeechRecognizer', 'DISPID_SLWLangId',
    'SAFT44kHz8BitStereo', 'SPLOADOPTIONS', 'DISPIDSPTSI',
    'SDTPronunciation', 'SVF_None', 'SPSModifier', 'SpeechWordType',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPRECOGNIZERSTATUS',
    'DISPID_SPIRule', 'SSTTWildcard', 'DISPID_SFSClose',
    'DISPID_SABIEventBias', 'DISPID_SVEVoiceChange',
    'SpeechDiscardType', 'DISPID_SPPValue', 'DISPID_SOTCSetId',
    'DISPID_SFSOpen', 'ISpeechObjectTokenCategory', 'DISPID_SRGReset',
    'SVSFDefault', 'SPAR_High', 'SAFT12kHz16BitStereo',
    'SVSFPurgeBeforeSpeak', 'DISPID_SpeechCustomStream',
    'SAFT16kHz8BitStereo', 'SAFTADPCM_44kHzStereo', 'DISPID_SRRAudio',
    'DISPID_SAStatus', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpeechLexiconWord', 'SWTDeleted', 'SAFTADPCM_11kHzStereo',
    'ISpeechDataKey', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechRecognizer', 'DISPID_SRRSaveToMemory',
    'SPEVENTENUM', 'ISpeechLexicon', 'SITooQuiet',
    'ISpeechLexiconWords', 'SLODynamic', 'SPEI_RESERVED5',
    'SpeechEngineProperties', 'DISPID_SABufferInfo',
    'eLEXTYPE_RESERVED6', 'SVSFlagsAsync', 'SVPOver',
    'SREInterference', 'DISPID_SVStatus', 'DISPID_SRAudioInput',
    'DISPID_SPAPhraseInfo', 'SVEEndInputStream', 'SPCATEGORYTYPE',
    'DISPID_SRGRecoContext', 'ISpSerializeState',
    'DISPID_SpeechLexiconPronunciation', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SVSLastBookmark', 'SPPS_Noun', 'DISPID_SVResume',
    'DISPID_SBSRead', 'SPEI_RESERVED3', 'DISPID_SpeechPhraseInfo',
    'SpeechStreamFileMode', 'DISPID_SPEsCount',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SVWaitUntilDone',
    'eLEXTYPE_PRIVATE1', 'SREAllEvents',
    'DISPID_SVSInputSentenceLength', 'STCInprocHandler',
    'DISPID_SGRsAdd', 'SVSFParseMask', 'ISpRecoContext',
    'DISPID_SGRSTPropertyId', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SPPParent', 'DISPID_SVVoice',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SABufferNotifySize', 'SVSFPersistXML',
    'Speech_Max_Word_Length', 'SAFT44kHz16BitMono',
    'DISPID_SPIEngineId', 'SREStreamStart', 'ISpeechAudioBufferInfo',
    'DISPID_SPAsItem', 'SpeechEngineConfidence',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPEAudioTimeOffset',
